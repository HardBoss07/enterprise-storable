...
VALUES 
(2, 'acd113ec-3452-4fa0-bddc-57d8bdfe2485', 1, 'testuser', 'folder', NULL, 'directory', 'b3b83802-1579-48cc-821f-a55364eb495b'),
(3, 'e17dbb63-16ab-484b-b6a4-59e0548eaa91', 1, 'm4tt3o', 'folder', NULL, 'directory', '6232b572-0107-436b-aef7-f4b2cfea5d00')
ON DUPLICATE KEY UPDATE id=id;

-- 3. Content for testuser (Under ID 2)
INSERT INTO nodes (id, owner_id, parent_id, name, kind, size, mime, storage_key)
VALUES 
(4, 'acd113ec-3452-4fa0-bddc-57d8bdfe2485', 2, 'documents', 'folder', NULL, 'directory', '8e23081f-24a6-483f-9306-0a11e83bf6c2'),
(5, 'acd113ec-3452-4fa0-bddc-57d8bdfe2485', 2, 'random-testuser-file.txt', 'file', 31, 'text/plain', '6c5106ff-54e6-4f8f-a159-85195763fc10')
ON DUPLICATE KEY UPDATE id=id;

-- 4. Content for m4tt3o (Under ID 3)
INSERT INTO nodes (id, owner_id, parent_id, name, kind, size, mime, storage_key)
VALUES 
...
INSERT INTO nodes (id, owner_id, parent_id, name, kind, size, mime, storage_key)
VALUES 
(8, 'acd113ec-3452-4fa0-bddc-57d8bdfe2485', 4, 'projects', 'folder', NULL, 'directory', 'da50d160-3161-42ba-a6bf-b0326bc5c3d2'),
