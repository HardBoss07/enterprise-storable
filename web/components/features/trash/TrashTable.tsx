 ...
 */
export function TrashTable({ items, onRestore, onPermanentDelete }: TrashTableProps) {
    const CLASSES = {
        container: "card-surface overflow-hidden",
        header: "grid grid-cols-12 gap-4 p-4 text-neutral-400 text-sm font-bold border-b border-neutral-700/50 mb-2",
