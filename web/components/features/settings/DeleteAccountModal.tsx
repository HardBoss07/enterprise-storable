...
export function DeleteAccountModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md">
      <div className="animate-in fade-in zoom-in bg-surface-200 flex w-full max-w-md flex-col overflow-hidden rounded-2xl border border-red-500/30 shadow-2xl duration-200">
        {/* Header */}
        <div className="border-surface-300 flex items-center justify-between border-b bg-red-500/5 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-6">
          <div className="flex gap-3 rounded-xl border border-red-500/20 bg-red-500/10 p-4">
            ...
            <div className="text-sm leading-relaxed text-red-200/80">
              <p className="mb-1 font-bold text-red-500 uppercase">WARNING: IRREVERSIBLE ACTION</p>
              Deleting your account will permanently wipe all your files, folders, and data. This
              cannot be undone.
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="border-surface-300 bg-surface-100 text-text-primary w-full rounded-xl border px-4 py-3 transition-all outline-none focus:ring-2 focus:ring-red-500/50"
              autoFocus
              required
            />
          </div>
          ...
          <div className="flex flex-col gap-3 pt-2">
            <Button
              ...
              className="w-full py-4 text-lg font-black tracking-wider uppercase"
            >
              DELETE EVERYTHING
            </Button>
            <Button
