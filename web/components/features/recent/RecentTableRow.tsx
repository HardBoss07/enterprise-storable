  ...
  return (
    <div className="group table-row-grid">
      ...
      <div className="text-text-muted col-span-3 text-sm">
        {file.modifiedAt ? format(new Date(file.modifiedAt), 'MMM d, yyyy HH:mm') : '--'}
      </div>
      ...
      <div className="col-span-1 flex items-center justify-end">
        {onNavigate && (
          <IconButton
            ...
            iconSize={16}
            title="Go to folder"
            className="text-blue-500 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-blue-500/10"
          />
        )}
      </div>
    </div>
