...
const COMMON_TEXT_EXTENSIONS = [
  "txt", "log", "md", "json", "js", "ts", "tsx", "jsx", "py", "sh", "bat", 
  "c", "cpp", "h", "hpp", "rs", "go", "java", "css", "scss", "html", "xml", 
  "yaml", "yml", "ini", "conf", "env", "gitignore"
];
 ...
 */
export function getFileConfig(extension: string | null | undefined): FileTypeConfig {
