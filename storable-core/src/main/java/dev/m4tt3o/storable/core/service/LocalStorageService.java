...
public class LocalStorageService implements StorageService {
    ...
    public void init() {
        ...
        try {
            ...
            throw new InternalStorableException(ErrorCode.STORAGE_FAILURE, "Could not initialize storage.");
        }
    }
    ...
    public void store(InputStream inputStream, String storageKey) {
        try {
            ...
            throw new InternalStorableException(ErrorCode.STORAGE_FAILURE, "Failed to store file: " + storageKey);
        }
    }
    ...
    public InputStream load(String storageKey) {
        try {
            ...
            throw new InternalStorableException(ErrorCode.STORAGE_FAILURE, "Could not read file: " + storageKey);
        }
    }
    ...
    public void delete(String storageKey) {
        try {
            ...
            throw new InternalStorableException(ErrorCode.STORAGE_FAILURE, "Could not delete file: " + storageKey);
        }
    }
