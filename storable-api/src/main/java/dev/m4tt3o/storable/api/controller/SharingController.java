...
public class SharingController {
    ...
    public ResponseEntity<List<dev.m4tt3o.storable.common.dto.FileMetadataDto>> getSharedWithMe(
    ...
    public ResponseEntity<AccessPrivilegeDto> shareNode(
            ...
            @AuthenticationPrincipal String userId) {
        return ResponseEntity.ok(sharingService.shareNode(nodeId, request.targetUserId(), request.level(), userId));
    }
    ...
    public ResponseEntity<AccessPrivilegeDto> updatePrivilege(
            ...
            @RequestBody ShareRequest request,
            @AuthenticationPrincipal String userId) {
        return ResponseEntity.ok(sharingService.updatePrivilege(nodeId, targetUserId, request.level(), userId));
    }
